<?php include 'header.php'; ?>
  ...
  <div class="row mainbody">
    ...
    <div class="row subbody container-fluid">
      ...
      <form action="chooseavatar.php" method="chooseavatar.php" class="">
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-8 col-md-8 has-error input_box">
            <input type="text" class="form-control" id="red_input" placeholder="Enter Username" name="uname"><span id='uname_error'></span>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-8 col-md-8 has-error input_box">
            <input type="email" class="form-control" id="green_input" placeholder="Enter Email" name="email"><span id='email_error'></span>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-8 col-md-8 has-error input_box">
            <input type="password" class="form-control" id="purple_input" placeholder="Enter Password" name="psw"><span id='pword_error'></span>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-8 col-md-8 has-error  input_box">
            <input type="password" class="form-control" id="blue_input" placeholder="Confirm Password" name="psw">
