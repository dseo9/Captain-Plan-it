    ...
    <div class="row subbody container-fluid">
      <div class="row">
        ...
        <div class="col-xs-4 col-xs-offset-4 col-sm-3 col-sm-offset-6 col-md-2 col-md-offset-6 col-lg-2 col-lg-offset-6">
          <a href="questions.php?id_question=<?php echo $level[3]['idQuestion']; ?>&planet=<?php echo $_GET['p_name']; ?>&bg=fruitheader.php&btn=a_fruit&lv=4"><img src="images\fruit_page\level_4.png" alt="level 4" class="img-responsive center-block"/></a>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-4 col-xs-offset-4 col-sm-3 col-sm-offset-6 col-md-2 col-md-offset-8 col-lg-2 col-lg-offset-8">
          <a href="questions.php?id_question=<?php echo $level[4]['idQuestion']; ?>&planet=<?php echo $_GET['p_name']; ?>&bg=fruitheader.php&btn=a_fruit&lv=5"><img src="images\fruit_page\level_5.png" alt="level 5" class="img-responsive center-block"/></a>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-4 col-xs-offset-4 col-sm-3 col-sm-offset-6 col-md-2 col-md-offset-6 col-lg-2 col-lg-offset-6">
          <a href="questions.php?id_question=<?php echo $level[5]['idQuestion']; ?>&planet=<?php echo $_GET['p_name']; ?>&bg=fruitheader.php&btn=a_fruit&lv=key"><img src="images\fruit_page\level_key.png" alt="key level" class="img-responsive center-block"/></a>
        </div>
      </div>
